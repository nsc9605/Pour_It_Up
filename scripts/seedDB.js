...
mongoose.connect(
  ...
  "mongodb://localhost/cocktailslist"
);

const cocktailSeed = [
  {
    name: "Espresso Martini",
    ingredients: [ "Vodka", "Khalua", "Espresso", "Simple Syrup" ],
  ...
  {
    name: "Penicillin",
    ingredients: [ "Blended Scotch", "Islay Scotch", "Honey-Ginger Syrup", "Fresh Lemon Juice" ],
